...
- **15 个顶层分组**：basics / layout / state_management / network / bluetooth / storage / image / animation / engine / video / ml / chart / packages / markdown / showcase
- **140+ 个叶子示例页面**：覆盖 Flutter 与端侧现代开发绝大部分核心与深度场景
...
| 文档 | 内容 |
|------|------|
| docs/demos.md | 示例分组详情（15 个分组，142 个叶子页面） |
