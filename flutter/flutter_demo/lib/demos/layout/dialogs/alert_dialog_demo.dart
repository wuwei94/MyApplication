...
class AlertDialogDemoPage extends StatelessWidget {
  const AlertDialogDemoPage({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return AlertDialogDemoView(title: title);
  }
}

class AlertDialogDemoView extends StatelessWidget {
  const AlertDialogDemoView({super.key, required this.title});
