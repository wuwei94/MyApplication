...
class StreamBuilderDemoPage extends StatelessWidget {
  const StreamBuilderDemoPage({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return StreamBuilderDemoView(title: title);
  }
}

class StreamBuilderDemoView extends StatefulWidget {
  const StreamBuilderDemoView({super.key, required this.title});

  final String title;

  @override
  State<StreamBuilderDemoView> createState() => _StreamBuilderDemoViewState();
}

class _StreamBuilderDemoViewState extends State<StreamBuilderDemoView> {
