...
class PoolItemAdapter(
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val titleView: TextView = view.findViewById(R.id.sample_pool_item_title)
        val descView: TextView = view.findViewById(R.id.sample_pool_item_desc)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.sample_item_pool_card, parent, false)
