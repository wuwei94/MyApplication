...
import com.example.william.my.module.sample.cache.RecyclerCacheExtension
import com.example.william.my.module.sample.databinding.UiItemRecyclerViewBinding
...
class RecyclerAdapter(private val data: List<String>?) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            UiItemRecyclerViewBinding.inflate(
