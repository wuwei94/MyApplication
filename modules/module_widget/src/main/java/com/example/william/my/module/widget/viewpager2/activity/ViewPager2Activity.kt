package com.example.william.my.module.widget.viewpager2.activity
...
import com.example.william.my.module.widget.databinding.UiActivityViewPager2Binding
...
class ViewPager2Activity : BaseVBActivity<UiActivityViewPager2Binding>() {
    ...
    private fun initViewPager() {
        binding.viewpager2View.orientation = ViewPager2.ORIENTATION_HORIZONTAL
        binding.viewpager2View.adapter = ViewPagerAdapter2(titles)

        binding.viewpager2Fragment.orientation = ViewPager2.ORIENTATION_HORIZONTAL
        binding.viewpager2Fragment.adapter = ViewPagerFragmentAdapter2(
