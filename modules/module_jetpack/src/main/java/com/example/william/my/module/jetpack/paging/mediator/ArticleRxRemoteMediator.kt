...
class ArticleRxRemoteMediator(
     ...
     */
    override fun initializeSingle(): Single<InitializeAction> = Single.fromCallable {
     ...
     */
    private fun loadPage(page: Int, loadType: LoadType): Single<MediatorResult> = networkApi.getArticleSingle(page)
        .subscribeOn(Schedulers.io())
        .map { response ->
