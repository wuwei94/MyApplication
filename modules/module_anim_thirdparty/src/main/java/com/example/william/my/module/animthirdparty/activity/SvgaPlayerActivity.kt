package com.example.william.my.module.animthirdparty.activity
...
import com.example.william.my.module.animthirdparty.databinding.AnimThirdpartyActivitySvgaBinding
 ...
 */
@Route(path = RouterPath.AnimThirdparty.SVGAPlayer)
class SvgaPlayerActivity : BaseVBActivity<AnimThirdpartyActivitySvgaBinding>() {

    override fun getViewBinding(): AnimThirdpartyActivitySvgaBinding {
        return AnimThirdpartyActivitySvgaBinding.inflate(layoutInflater)
    }
