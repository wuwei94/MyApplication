...
import com.example.william.my.module.performance.adapter.PoolItemAdapter
import com.example.william.my.module.performance.adapter.PoolPagerAdapter
import com.example.william.my.module.performance.databinding.PerformanceLayoutPoolPagerBinding
import com.example.william.my.module.performance.manager.RecycledViewPoolManager
...
class RecycledViewPoolActivity : BasicRecyclerActivity() {
    ...
    private lateinit var poolBinding: PerformanceLayoutPoolPagerBinding
    ...
    override fun initView(savedInstanceState: Bundle?) {
        ...
        // 配置全局复用池对卡片类型的最大容量
        RecycledViewPoolManager.setMaxRecycledViews(PoolItemAdapter.VIEW_TYPE_CARD, 15)
    ...
    private fun initViewPager() {
        ...
        // 统一使用全局共享的 RecycledViewPoolManager
        poolBinding.performancePoolViewPager.adapter = PoolPagerAdapter(
            sharedViewPool = RecycledViewPoolManager.getPool(),
