package com.example.william.my.module.custom_view.activity
...
import com.example.william.my.module.custom_view.R
import com.example.william.my.module.custom_view.databinding.DemoActivityMarqueeViewBinding
 ...
 * - 任何需要垂直滚动的场景
 */
@Route(path = RouterPath.CustomView.MarqueeView)
