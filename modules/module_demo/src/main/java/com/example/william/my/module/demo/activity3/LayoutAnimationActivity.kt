...
import com.example.william.my.module.demo.databinding.DemoActivityLayoutAnimationBinding
import com.example.william.my.module.demo.widget.MicLayoutManager
import androidx.core.graphics.toColorInt

@Route(path = RouterPath.Demo.LayoutAnimation)
class LayoutAnimationActivity : BaseVBActivity<DemoActivityLayoutAnimationBinding>() {
    ...
    override fun getViewBinding(): DemoActivityLayoutAnimationBinding {
        return DemoActivityLayoutAnimationBinding.inflate(layoutInflater)
    }
