package com.example.william.my.module.mavericks.article.adapter
...
import com.example.william.my.module.mavericks.R
...
class ArticleAdapter(data: ArrayList<ArticleDetailData>) :
    ...
    override fun onCreateViewHolder(
        ...
        return QuickViewHolder(R.layout.mavericks_item_recycler, parent)
    }
}
