 ...
 * - OkHttp WebSocket 普通版本 / RxJava 封装 / Coroutines Flow 封装
 * - Java-WebSocket 普通版本 / RxJava 封装 / Coroutines Flow 封装
 * - Netty TCP 普通版本 / RxJava 封装 / Coroutines Flow 封装
 *
...
class WebSocketMainActivity : RouterRecyclerActivity() {
    ...
    override fun buildRouter(): ArrayList<RouterItem> {
        ...
        routerItems.add(RouterItem("OkHttp WebSocket (Flow 封装)", RouterPath.WebSocket.OkHttpWebSocketClientFlow))
        ...
        routerItems.add(RouterItem("Java-WebSocket (Flow 封装)", RouterPath.WebSocket.JavaWebSocketClientFlow))
        routerItems.add(RouterItem("", ""))
        ...
        routerItems.add(RouterItem("Netty TCP Socket (Flow 封装)", RouterPath.WebSocket.NettyWebSocketClientFlow))
        return routerItems
    }
}
