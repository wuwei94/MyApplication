 ...
 *     addNetworkInterceptor(InterceptorProgressUpload { current, total ->
 *         Log.d("Upload", "$current/$total")
 *     })
 * }
 * ```
 */
class InterceptorProgressUpload(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val wrappedBody = RequestBodyProgressUpload(requestBody, listener)
