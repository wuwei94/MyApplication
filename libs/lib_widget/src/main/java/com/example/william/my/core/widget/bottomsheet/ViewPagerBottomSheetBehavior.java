...
public class ViewPagerBottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public abstract static class BottomSheetCallback {
         ...
         */
        public abstract void onStateChanged(View bottomSheet, @State int newState);
     ...
     * @deprecated use {@link #addBottomSheetCallback(BottomSheetBehavior.BottomSheetCallback)} and {@link
     * #removeBottomSheetCallback(BottomSheetBehavior.BottomSheetCallback)} instead
     */
    @Deprecated
...
//    }
    ...
    private void setSystemGestureInsets(View child) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && !isGestureInsetBottomIgnored() && !peekHeightAuto) {
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        public SavedState(Parcelable superState, ViewPagerBottomSheetBehavior<?> behavior) {
            super(superState);
    ...
    private void addAccessibilityActionForState(
        ...
        ViewCompat.replaceAccessibilityAction(
                ...
                new AccessibilityViewCommand() {
                    @Override
                    public boolean perform(@NonNull View view, CommandArguments arguments) {
                        setState(state);
                        return true;
                    }
                });
