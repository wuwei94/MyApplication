...
class ListenableBuilderExample extends StatelessWidget {
  const ListenableBuilderExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return ListenableBuilderRoute(title: title);
  }
}

class ListenableBuilderRoute extends StatefulWidget {
  const ListenableBuilderRoute({super.key, required this.title});

  final String title;

  @override
  State<ListenableBuilderRoute> createState() => _ListenableBuilderRouteState();
}

class _ListenableBuilderRouteState extends State<ListenableBuilderRoute> {
