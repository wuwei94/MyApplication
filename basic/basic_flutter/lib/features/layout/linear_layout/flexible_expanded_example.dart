...
/// Flexible & Expanded Example
/// Demonstrates the usage of Flexible and Expanded widgets
class FlexibleExpandedExample extends StatelessWidget {
  const FlexibleExpandedExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return FlexibleExpandedRoute(title: title);
  }
}

class FlexibleExpandedRoute extends StatelessWidget {
  const FlexibleExpandedRoute({super.key, required this.title});
