...
class BackdropFilterExample extends StatelessWidget {
  const BackdropFilterExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return BackdropFilterRoute(title: title);
  }
}

class BackdropFilterRoute extends StatelessWidget {
  const BackdropFilterRoute({super.key, required this.title});
