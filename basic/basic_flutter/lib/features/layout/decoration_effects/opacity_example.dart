...
class OpacityExample extends StatelessWidget {
  const OpacityExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return OpacityRoute(title: title);
  }
}

class OpacityRoute extends StatefulWidget {
  const OpacityRoute({super.key, required this.title});

  final String title;

  @override
  State<OpacityRoute> createState() => _OpacityRouteState();
}

class _OpacityRouteState extends State<OpacityRoute> {
  double _opacity = 1.0;
