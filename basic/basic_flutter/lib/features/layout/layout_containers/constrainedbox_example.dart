...
class ConstrainedBoxExample extends StatelessWidget {
  const ConstrainedBoxExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return ConstrainedBoxRoute(title: title);
  }
}

class ConstrainedBoxRoute extends StatelessWidget {
  const ConstrainedBoxRoute({super.key, required this.title});
