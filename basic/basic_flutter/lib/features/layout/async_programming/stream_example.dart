...
class StreamExample extends StatelessWidget {
  const StreamExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return StreamRoute(title: title);
  }
}

class StreamRoute extends StatefulWidget {
  const StreamRoute({super.key, required this.title});

  final String title;

  @override
  State<StreamRoute> createState() => _StreamRouteState();
}
