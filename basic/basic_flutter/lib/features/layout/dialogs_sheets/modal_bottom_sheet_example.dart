...
class ModalBottomSheetExample extends StatelessWidget {
  const ModalBottomSheetExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return ModalBottomSheetRoute(title: title);
  }
}

class ModalBottomSheetRoute extends StatelessWidget {
  const ModalBottomSheetRoute({super.key, required this.title});
