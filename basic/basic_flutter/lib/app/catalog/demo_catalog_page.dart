...
import 'package:basic_flutter/app/router/app_navigator.dart';
import 'package:flutter/material.dart';

/// 通用 Demo 目录页：首页展示分组，分组页展示具体示例
class DemoCatalogPage extends StatelessWidget {
  final String title;
  final List<CatalogItem> routes;

  const DemoCatalogPage({super.key, required this.title, required this.routes});

  void _handleTap(BuildContext context, CatalogItem item) {
    ...
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemBuilder: (context, index) {
          final CatalogItem item = routes[index];
          return ListTile(
