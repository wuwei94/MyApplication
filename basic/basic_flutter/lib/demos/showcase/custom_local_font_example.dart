...
/// Custom Local Font
/// 使用本地自定义字体的示例页面
class CustomLocalFontDemoPage extends StatelessWidget {
  const CustomLocalFontDemoPage({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return CustomLocalFontDemoView(title: title);
  }
}

class CustomLocalFontDemoView extends StatelessWidget {
  const CustomLocalFontDemoView({super.key, required this.title});
