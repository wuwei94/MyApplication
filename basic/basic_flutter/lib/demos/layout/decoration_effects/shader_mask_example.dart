...
class ShaderMaskExample extends StatelessWidget {
  const ShaderMaskExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return ShaderMaskRoute(title: title);
  }
}

class ShaderMaskRoute extends StatelessWidget {
  const ShaderMaskRoute({super.key, required this.title});
