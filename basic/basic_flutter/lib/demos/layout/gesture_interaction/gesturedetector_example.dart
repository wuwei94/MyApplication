...
class GestureDetectorExample extends StatelessWidget {
  const GestureDetectorExample({super.key, required this.title});

  final String title;

  @override
  Widget build(BuildContext context) {
    return GestureDetectorRoute(title: title);
  }
}
...
class GestureDetectorRoute extends StatefulWidget {
  ...
  @override
  State<GestureDetectorRoute> createState() => _GestureDetectorRouteState();
}
