package com.example.william.my.core.base.usecase
 ...
 */
abstract class MaybeObserverUseCase<ReturnType : Any> {
    ...
    protected abstract fun buildUseCaseObservable(): Maybe<ReturnType>

    fun execute(observer: DisposableMaybeObserver<ReturnType>) {
