...
interface ArticleRepository<Article, ArticleDetail> {
     ...
     */
    fun getArticleFlowByRx(page: Int): Flow<RetrofitResponse<Article>>

    /**
     * 纯协程 Flow 构建：通过 flow { ... } 发送 loading/error/success 状态。
     */
    fun getArticleFlow(page: Int): Flow<RetrofitResponse<Article>>

    /**
     * LiveData 转 Flow：将 LiveData 转换为 Kotlin 响应式 Flow (asFlow)。
     */
    fun getArticleFlowByLiveData(page: Int): Flow<RetrofitResponse<Article>>
     ...
     */
    fun getArticleLiveDataByRx(page: Int): LiveData<RetrofitResponse<Article>>
     ...
     */
    fun getArticleLiveDataByFlow(page: Int): LiveData<RetrofitResponse<Article>>
    ...
    ): NetworkResult<List<ArticleDetail>>
}
